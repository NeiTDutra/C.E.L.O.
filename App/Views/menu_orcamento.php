...
<div class="menu">
	...
	<form action="<?php echo $_SERVER ['PHP_SELF'] ?>" method="post">
		...
		<fieldset><legend>Menu de orçamento</legend>
			...
			<?php  echo isset($_POST['sobe_ver_orc']) ? '<input type="button" 
			                                             onClick="up_impress()" 
			                                             value="Gerar PDF" 
			                                             class="altera">' : null; ?>
			<br>
		...
		<fieldset class="f_fds"><legend>Operador</legend>
			...
			<input type="hidden" 
			       name="id_usu" 
			       value="<?php echo isset($_SESSION['cod_usu']) ? $_SESSION['cod_usu'] : null; ?>"
			       >
...
<?php 
	...
	if (isset($_POST['novo_orc']) || 
	    isset($_POST['sobe_altera_cli']) || 
	    isset($_POST['p_cli']) || 
	    isset($_POST['p_prod']) || 
	    isset($_SESSION['n_orc'])){
