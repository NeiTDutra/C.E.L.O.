	...
	<div class="menu">
		...
		<form action="<?php echo $_SERVER ['PHP_SELF'] ?>" method="post">
			...
			<fieldset><legend>Menu de orçamento</legend>
				...
				<input type="submit" name="listar_orc" value="Listar" class="lista">
				...
				<?php  echo isset($_POST['sobe_ver_orc']) ? '<input type="button" onClick="up_impress()" value="Imprimir" class="altera">' : null; ?>
				<br>
				<br>
